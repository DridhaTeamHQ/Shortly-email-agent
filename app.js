...
function generatePreviewHtml() {
  ...
  function renderFooter() {
    ...
    return `<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top:28px"><tr><td style="padding:22px 28px 18px;background:#fff"><table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr><td style="padding-bottom:16px"><img src="${previewFooterLogoUrl}" alt="Dailymattr" width="210" style="display:block;width:210px;max-width:100%;height:auto;border:0" /></td></tr><tr><td>${socialIcon("https://www.instagram.com/dailymattr", previewInstagramIconUrl, "Instagram", "Instagram")}${socialIcon(twitterUrl, "", "X", "X")}${socialIcon(linkedinUrl, "", "LinkedIn", "in")}</td><td style="text-align:right"><a href="https://longmattr.com/" style="display:inline-block;background:#3979ff;color:#fff;border-radius:24px;padding:12px 20px;text-decoration:none;font:700 15px/1 Roboto,Arial,sans-serif">Subscribe&nbsp;&rarr;</a></td></tr></table></td></tr><tr><td style="background:#3979ff;color:#fff;padding:16px 28px"><table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr><td style="font:700 15px/1.2 Roboto,Arial,sans-serif">Read from anywhere</td><td style="text-align:right">${storeButton("https://play.google.com/store", previewGooglePlayIconUrl, "Google Play")}&nbsp;${storeButton("https://www.apple.com/app-store/", previewAppStoreIconUrl, "App Store")}</td></tr></table></td></tr></table>`;
  }
